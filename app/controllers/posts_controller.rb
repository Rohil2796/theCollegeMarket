...
def create
  ...
  private
    ...
    def post_params
      ...
      :tb_classname, :tb_classnumber, :offerrequest, :posttype, categories: [], category: [], :category_id, category_id: [], categories_id: [], post_attachments_attributes: [:id, :post_id, :avatar])
    end
