...
class TbpostsInterfaceTest < ActionDispatch::IntegrationTest
  ...
  test "tbpost interface" do
    ...
    first_tbpost = @user.tbposts.paginate(page: 1).first
    assert_difference 'Micropost.count', -1 do
      delete tbposts_path(first_tbpost)
    end
